...
trait Authorizable
{
    ...
    {
        return ! is_null(Gate::getPolicyFor(static::newModel())) || static::hasAbilities();
    }
    ...
    {
        return isset(static::$permissionsForAbilities[$ability]);
    }

    public static function modelHasAbility(string $ability): bool
    {
        return method_exists(Gate::getPolicyFor(static::newModel()), $ability) || static::hasAbility($ability);
    }

    public function resourceHasAbility(string $ability): bool
    {
        return method_exists(Gate::getPolicyFor($this->model()), $ability) || static::hasAbility($ability);
    }
    ...
    public function authorizeToViewAny(Request $request)
    {
        ...
        if (static::modelHasAbility('viewAny')) {
    ...
    public static function authorizedToViewAny(Request $request)
    {
        ...
        return static::modelHasAbility('viewAny')
            ? Gate::check('viewAny', get_class(static::newModel())) || static::hasPermissionTo('viewAny')
            : true;
    }
    ...
    public static function authorizedToCreate(Request $request)
    {
        if (static::authorizable()) {
            return Gate::check('create', get_class(static::newModel()))
                || static::hasPermissionTo('create', get_class(static::newModel()));
        }
    ...
    public function authorizedToAdd(NovaRequest $request, $model)
    {
        ...
        return static::resourceHasAbility($method)
            ? Gate::check($method, $this->model()) || static::hasPermissionTo($method)
            : true;
    }
    ...
    public function authorizedToAttach(NovaRequest $request, $model)
    {
        ...
        return static::resourceHasAbility($method)
            ? Gate::check($method, [$this->model(), $model]) || static::hasPermissionTo($method)
            : true;
    }
    ...
    public function authorizedTo(Request $request, $ability)
    {
        return static::authorizable()
            ? Gate::check($ability, $this->resource) || static::hasPermissionTo($ability)
            : true;
    }
    ...
    public static function hasPermissionTo(string $ability)
    {
        if (isset(static::$permissionsForAbilities[$ability])) {
            if (request()->user()->can(static::$permissionsForAbilities[$ability])) {
                return true;
            }
        }
