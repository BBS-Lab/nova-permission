<router-link tag="h3" :to="{name: 'nova-permission'}" class="cursor-pointer flex items-center font-normal dim text-white mb-6 text-base no-underline">
    ...
    <span class="sidebar-label">
        {{ trans('nova-permission::permission-builder.menu') }}
    </span>
</router-link>
